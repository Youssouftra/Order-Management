...
public class DatabaseConnection {
    ...
    private static void loadProperties() {
        ...
        try (InputStream input = DatabaseConnection.class.getClassLoader()
            ...
            props.load(input);
            URL = props.getProperty("db.url", "jdbc:postgresql://localhost:5432/orderManagement");
            USER = props.getProperty("db.username", "orderManager");
            PASSWORD = props.getProperty("db.password", "Sniper12");
